...
invokerDisplay.option = Menu.AddOptionBool({ "Hero Specific", "Invoker","Invoker Display"}, "Enable", false)
invokerDisplay.boxSizeOption = Menu.AddOptionSlider({ "Hero Specific", "Invoker", "Invoker Display"}, "Cooldown Display Size", 21, 200, 5)
invokerDisplay.boxY = Menu.AddOptionSlider({ "Hero Specific", "Invoker","Invoker Display" }, "Y position", -500, 500, 10)
...
invokerDisplay.sortAbilitiesOption = Menu.AddOptionBool({ "Hero Specific", "Invoker", "Invoker Display" }, "Sort Abilities by Name", false)
