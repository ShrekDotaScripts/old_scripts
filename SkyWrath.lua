...
for k, v in pairs(SkyWrathMage.menuAbilities) do
	SkyWrathMage.AbilitiesOptionID[k] = Menu.AddOptionBool({"Hero Specific", "SkyWrathMage", "Abilities"}, SkyWrathMage.menuAbilities[k], false)
end

SkyWrathMage.IsPopLinkenToggled = Menu.AddOptionBool({"Hero Specific", "SkyWrathMage", "Pop Linkens Items"}, "Enabled Pop Linken", "")
...
for k, v in pairs(SkyWrathMage.menuPopupLinkens) do
	SkyWrathMage.PopLinkensOptionID[k] = Menu.AddOptionBool({"Hero Specific", "SkyWrathMage", "Pop Linkens Items"}, SkyWrathMage.menuPopupLinkens[k], false)
end

SkyWrathMage.IsPopAMReflectToggled = Menu.AddOptionBool({"Hero Specific", "SkyWrathMage", "Pop Antimage's Reflect Items"}, "Enabled Pop AM Reflect", "")
...
for k, v in pairs(SkyWrathMage.menuPopupAMReflect) do
	SkyWrathMage.PopupAMReflectOptionID[k] = Menu.AddOptionBool({"Hero Specific", "SkyWrathMage", "Pop Antimage's Reflect Items"}, SkyWrathMage.menuPopupAMReflect[k], false)
end

SkyWrathMage.IsBMToggled = Menu.AddOptionBool({"Hero Specific", "SkyWrathMage"}, "Check for BladeMail", false)
SkyWrathMage.IsSRToggled = Menu.AddOptionBool({"Hero Specific", "SkyWrathMage"}, "Use Soul Ring", false)
SkyWrathMage.IsBlinkToggled = Menu.AddOptionBool({"Hero Specific", "SkyWrathMage"}, "Use Blink Dagger", false)
SkyWrathMage.IsEZKChecked = Menu.AddOptionBool({"Hero Specific", "SkyWrathMage"}, "Check for EZ Kill", false)
SkyWrathMage.EZTogglerKey = Menu.AddKeyOption({"Hero Specific", "SkyWrathMage"}, "EZ Kill Toggle Key", Enum.ButtonCode.KEY_V)
SkyWrathMage.IsDoubleUltiToggled = Menu.AddOptionBool({"Hero Specific", "SkyWrathMage"}, "Double ulti mode", false)
